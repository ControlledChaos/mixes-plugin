...
class Post_Types_Taxes {
	...
	public function dependencies() {
		...
		require_once MMP_PATH . 'includes/post-types-taxes/class-register-post-types.php';

		// Resister cutsom taxonomies.
		require_once MMP_PATH . 'includes/post-types-taxes/class-register-taxonomies.php';

		// Functions related to post types and taxonomies.
		require_once MMP_PATH . 'includes/post-types-taxes/class-post-type-tax-functions.php';

		// Post types query on the blog front page.
		require_once MMP_PATH . 'includes/post-types-taxes/class-post-type-front-page.php';

		// Number of posts per archive page.
		require_once MMP_PATH . 'includes/post-types-taxes/class-posts-per-page.php';
