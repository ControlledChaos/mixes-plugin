...
namespace Mixes_Plugin\Includes\Editor_Blocks;
...
class Register_Blocks {
	...
	public function block_editor_assets() {
		...
		wp_enqueue_script(
			'mmp-sample-block-script', // Handle.
			...
			filemtime( MMP_PATH . 'includes/editor-blocks/assets/js/sample-block.min.js' ) // filemtime — Gets file modification time.
		);

		// Sample block styles.
		wp_enqueue_style(
			'mmp-sample-block', // Handle.
			...
			filemtime( MMP_PATH . 'includes/editor-blocks/assets/css/sample-block.min.css' ) // filemtime — Gets file modification time.
		);
	...
	public function block_frontend_assets() {
		...
		wp_enqueue_style(
			...
			[ 'wp-blocks' ],
			filemtime( MMP_PATH . 'includes/editor-blocks/assets/css/sample-block.css' )
		);
