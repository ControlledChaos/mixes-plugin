...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'mmp_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( mmp_acf_options() ) {
			...
			$blog_image    = get_field( 'mmp_meta_blog_image', 'option' );
			$default_image = get_field( 'mmp_meta_default_image', 'option' );
