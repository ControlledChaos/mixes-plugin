...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( mmp_acf_options() ) {
            ...
            $options = get_field( 'mmp_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( mmp_acf_options() ) {
            $links = get_field( 'mmp_links_manager', 'option' );
        } else {
            $links = get_option( 'mmp_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( mmp_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'mmp_hide_appearance' );
            $plugins    = get_option( 'mmp_hide_plugins' );
            $users      = get_option( 'mmp_hide_users' );
            $tools      = get_option( 'mmp_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( mmp_acf_options() ) {
            ...
            $menus_link   = get_field( 'mmp_menus_position', 'option' );
            $widgets_link = get_field( 'mmp_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'mmp_menus_position' );
            $widgets_link = get_option( 'mmp_widgets_position' );
