	...
	public function settings_fields() {
		...
		if ( function_exists( 'acf_add_local_field_group' ) ) :
			...
			acf_add_local_field_group( [
				...
				'title'  => __( 'Settings Page', 'mixes-plugin' ),
				'fields' => [
					...
					[
						...
						'label'             => __( 'Admin Menu', 'mixes-plugin' ),
						'name'              => '',
						'type'              => 'tab',
						'instructions'      => __( '', 'mixes-plugin' ),
						'required'          => 0,
					...
					[
						...
						'label'             => __( 'Settings Page', 'mixes-plugin' ),
						'name'              => 'mmp_settings_link_position',
						'type'              => 'button_group',
						'instructions'      => __( 'Select the position of this Settings page link, and whether to show or hide the other settings links.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'choices'           => [
							'default' => __( 'Default/Show', 'mixes-plugin' ),
							'top'     => __( 'Top Level/Hide', 'mixes-plugin' ),
						],
						'allow_null'        => 0,
					...
					[
						...
						'label'             => __( 'Site Settings Label', 'mixes-plugin' ),
						'name'              => 'mmp_site_settings_link_label',
						'type'              => 'text',
						'instructions'      => __( 'Change the label of the link to this page.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '50',
						...
						'default_value'     => '',
						'placeholder'       => __( 'Site Settings', 'mixes-plugin' ),
						'prepend'           => '',
						'append'            => '',
						'maxlength'         => '',
					],
					[
						...
						'label'             => __( 'Site Settings Icon', 'mixes-plugin' ),
						'name'              => 'mmp_site_settings_link_icon',
						'type'              => 'text',
						'instructions'      => __( 'Enter a Dashicons CSS class for the icon of the link to this page.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '50',
					...
					[
						...
						'label'             => __( 'Site Plugin Position', 'mixes-plugin' ),
						'name'              => 'mmp_site_plugin_link_position',
						'type'              => 'button_group',
						'instructions'      => __( 'Make the site-specific plugin admin page a top-level link.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'choices'           => [
							'default' => __( 'Under Plugins', 'mixes-plugin' ),
							'top'     => __( 'Top Level', 'mixes-plugin' ),
						],
						'allow_null'        => 0,
						'default_value'     => 'default',
						'layout'            => 'horizontal',
					...
					[
						...
						'label'             => __( 'Site Plugin Label', 'mixes-plugin' ),
						'name'              => 'mmp_site_plugin_link_label',
						'type'              => 'text',
						'instructions'      => __( 'Change the label of the link to this page.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
					...
					[
						...
						'label'             => __( 'Site Plugin Icon', 'mixes-plugin' ),
						'name'              => 'mmp_site_plugin_link_icon',
						'type'              => 'text',
						'instructions'      => __( 'Enter a Dashicons CSS class for the icon of the link to this page.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
					...
					[
						...
						'label'             => __( 'Menus Link', 'mixes-plugin' ),
						'name'              => 'mmp_menus_position',
						'type'              => 'button_group',
						'instructions'      => __( 'Select the position of the Menus page link.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'choices'           => [
							'top'     => __( 'Top Level', 'mixes-plugin' ),
							'default' => __( 'Default', 'mixes-plugin' ),
						],
						'allow_null'        => 0,
						'default_value'     => 'top',
						'layout'            => 'horizontal',
					...
					[
						...
						'label'             => __( 'Widgets Link', 'mixes-plugin' ),
						'name'              => 'mmp_widgets_position',
						'type'              => 'button_group',
						'instructions'      => __( 'Select the position of the Widgets page link.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
					...
					[
						...
						'label'             => __( 'Hide Links', 'mixes-plugin' ),
						'name'              => 'mmp_admin_hide_links',
						'type'              => 'checkbox',
						'instructions'      => __( 'Select which menu items to hide.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper' => [
							'width' => '',
						...
						'choices'           => [
							'themes'  => __( 'Appearance', 'mixes-plugin' ),
							'plugins' => __( 'Plugins', 'mixes-plugin' ),
					...
					[
						...
						'label'             => __( 'Admin Pages', 'mixes-plugin' ),
						'name'              => '',
						'type'              => 'tab',
						'instructions'      => __( '', 'mixes-plugin' ),
						'required'          => 0,
					...
					[
						...
						'label'             => __( 'Admin Header', 'mixes-plugin' ),
						'name'              => 'mmp_use_admin_header',
						'type'              => 'true_false',
						'instructions'      => __( 'Add the site title, site tagline, and a nav menu to the top of admin pages.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'message'           => __( 'Use the admin header.', 'mixes-plugin' ),
						'default_value'     => 0,
						'ui'                => 1,
						'ui_on_text'        => __( 'Yes', 'mixes-plugin' ),
						'ui_off_text'       => __( 'No', 'mixes-plugin' ),
					...
					[
						...
						'label'             => __( 'Drag & Drop Sort Order', 'mixes-plugin' ),
						'name'              => 'mmp_use_custom_sort_order',
						'type'              => 'true_false',
						...
						The order you set on the admin management screens will automatically set the order of the posts in the blog index pages and in archive pages.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'message'           => __( 'Add drag & drop sort order functionality to post types and taxonomies.', 'mixes-plugin' ),
						'default_value'     => 0,
						'ui' => 1,
						'ui_on_text'        => __( 'Yes', 'mixes-plugin' ),
						'ui_off_text'       => __( 'No', 'mixes-plugin' ),
					...
					[
						...
						'label'             => __( 'Admin Footer Credit', 'mixes-plugin' ),
						'name'              => 'mmp_admin_footer_credit',
						'type'              => 'text',
						'instructions'      => __( 'The "developed by" credit.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
					...
					[
						...
						'label'             => __( 'Admin Footer Link', 'mixes-plugin' ),
						'name'              => 'mmp_admin_footer_link',
						'type'              => 'url',
						'instructions'      => __( 'Link to the website devoloper.', 'mixes-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
 ...
 */
function mmp_settings_fields_acf() {
