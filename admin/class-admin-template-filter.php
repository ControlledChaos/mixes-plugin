...
class Filter_By_Template {
	...
	public function filter_dropdown() {
		...
		<select name="page_template_filter" id="page_template_filter">
			<option value="all"><?php _e( 'All Page Templates', 'mixes-plugin' ); ?></option>
			<option value="default" <?php echo ( $template == 'default' ) ? ' selected="selected" ' : ''; ?>><?php echo _e( 'Default Template', 'mixes-plugin' ); ?></option>
	        ...
	        if ( $template ) {
	        	...
	        	if ( $template == 'default' ) {
					...
					echo sprintf(
						...
						__( 'Default Template', 'mixes-plugin' ),
						__( 'Default Template', 'mixes-plugin' )
					);
				...
				// If it's not the default template.
					...
					// If the template cannot be found.
	        			...
	        			echo sprintf(
							'<span title="%1s">%2s</span>',
							__( 'This template file does not exist', 'mixes-plugin' ),
							$template
						);
					}
 ...
 */
function mmp_filter_by_template() {
