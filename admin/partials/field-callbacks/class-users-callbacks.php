...
class Users_Callbacks {
	...
	public function block_gravatar( $args ) {
		...
		$option = get_option( 'mmp_block_gravatar' );

		$html = '<p><input type="checkbox" id="mmp_block_gravatar" name="mmp_block_gravatar" value="1" ' . checked( 1, $option, false ) . '/>';

		$html .= '<label for="mmp_block_gravatar"> ' . $args[0] . '</label></p>';
