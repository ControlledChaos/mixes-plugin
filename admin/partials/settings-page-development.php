...
$page_tabs = apply_filters( 'mmp_tabs_development', $tabs );
...
if ( 'general' == $active_tab ) {
    $section = 'mmp-site-development-general';
    $fields  = 'mmp-site-development-general';
} else {
    $section = null;
    $fields  = null;
}
...
$do_section = apply_filters( 'mmp_section_development', $section );
$do_fields  = apply_filters( 'mmp_fields_development', $fields );
...
<div id="setting-error-settings_updated" class="notice notice-success is-dismissible">
	<p><strong><?php _e( 'Settings saved.', 'mixes-plugin' ); ?></strong></p>
</div>
<?php } ?>
<div class="wrap">
	<?php echo sprintf( '<h1 class="wp-heading-inline">%1s %2s</h1>', get_bloginfo( 'name' ), esc_html__( 'Development', 'mixes-plugin' ) ); ?>
	<p class="description"><?php _e( 'A few tools that come in handy during the development of your website.', 'mixes-plugin' ); ?></p>
